...
reaclib = "/mnt/home/agarw132/jina/nucdata/reaclib2_def2"
winvname = "winvn_v3.0_sky_z60"
nuclib = NuclideLibrary.CreateFromWinv("/mnt/home/agarw132/jina/nucdata/" + str(winvname))
...
output = net.EvolveSelfHeatingWithInitialTemperature(nseResult.Y(), 0.0, 1.0E5,
                                                     T0, densityProfile, "/mnt/scratch/agarw132/jina/r_process_grid/Skynet_y" + str(Ye) + "_s" + str(s))

YvsA = np.array(output.FinalYVsA())
A = np.arange(len(YvsA))

np.savetxt("/mnt/scratch/agarw132/jina/r_process_grid/final_y" + str(Ye) + "_s" + str(s), np.array([A, YvsA]).transpose(),
    "%6i  %30.20E")
