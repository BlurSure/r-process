...
nuclib = NuclideLibrary.CreateFromWinv("/mnt/home/agarw132/jina/nucdata/nuclibs/winvn_v3.0_sky_z60")
...
strongReactionLibrary = REACLIBReactionLibrary("/mnt/home/agarw132/jina/nucdata/reaclibs/reaclib2_def2",
...
weakReactionLibrary = REACLIBReactionLibrary("/mnt/home/agarw132/jina/nucdata/reaclibs/reaclib2_def2",
...
Ye = 0.27   # initial Ye
s = 44    # initial entropy in k_B / baryon
...
output = net.EvolveSelfHeatingWithInitialTemperature(nseResult.Y(), 0.0, 1.0E5,
    T0, densityProfile, "./Skynet_def2_44_0.27")

NetworkOutput.MakeDatFile("./Skynet_def2_44_0.27.h5")
