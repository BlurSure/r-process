...
output = net.EvolveSelfHeatingWithInitialTemperature(nseResult.Y(), 0.0, 1.0E5,
    T0, densityProfile, "/projects/jina/jina_ashley/conditiongrid/nb22/Skynet_y0.33_s10")

NetworkOutput.MakeDatFile("/projects/jina/jina_ashley/conditiongrid/nb22/Skynet_y0.33_s10.h5")

YvsA = np.array(output.FinalYVsA())
A = np.arange(len(YvsA))

np.savetxt("/projects/jina/jina_ashley/conditiongrid/nb22/final_y0.33_s10", np.array([A, YvsA]).transpose(),
    "%6i  %30.20E")
