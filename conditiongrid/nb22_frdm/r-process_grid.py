...
reaclib = "/mnt/home/agarw132/jina/nucdata/reaclibs/reaclib2_nb22_frdm12_2"
...
output = net.EvolveSelfHeatingWithInitialTemperature(nseResult.Y(), 0.0, 1.0E5,
                                                     T0, densityProfile, "/mnt/scratch/agarw132/jina/r_process_grid_nb22_frdm/Skynet_y" + str(Ye) + "_s" + str(s))

YvsA = np.array(output.FinalYVsA())
A = np.arange(len(YvsA))

np.savetxt("/mnt/scratch/agarw132/jina/r_process_grid_nb22_frdm/final_y" + str(Ye) + "_s" + str(s), np.array([A, YvsA]).transpose(),
    "%6i  %30.20E")
