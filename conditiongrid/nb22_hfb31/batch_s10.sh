...
#SBATCH -o /evtdata/jina1/Skynet_Ashley/slurmlogs/s10_%a.txt
#SBATCH -e /evtdata/jina1/Skynet_Ashley/slurmlogs/s10_%a.txt
...
python r-process_s10.py ${SLURM_ARRAY_TASK_ID}
