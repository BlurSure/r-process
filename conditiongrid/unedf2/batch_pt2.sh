...
#SBATCH -o /evtdata/jina1/Skynet_Ashley/slurmlogs/pt2_%a.txt
#SBATCH -e /evtdata/jina1/Skynet_Ashley/slurmlogs/pt2_%a.txt
...
python r-process_grid_pt2.py ${SLURM_ARRAY_TASK_ID}
